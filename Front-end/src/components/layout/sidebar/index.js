...
const Sidebar=()=>{
    return(
        <div className="hidden md:block min-w-[20%] max-w-[300px]">
               <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <a className="nav-link  active" href="../pages/dashboard.html">
                                ...
                                <span className="nav-link-text ms-1 font-sans">Dashboard</span>
                            </a>
                        </li>
                ...
                <div className="sidenav-footer mx-3" style={{ position: 'sticky', bottom: 0, zIndex: 1000 }}>
